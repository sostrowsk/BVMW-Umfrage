...
import { Plus, Trash2, GripVertical, Save, Eye, Settings, Copy } from 'lucide-react'
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setSurveyData({
                    ...surveyData,
                    config: { ...surveyData.config, estimatedTime: parseInt(e.target.value) }
                  })}
                />
              </div>
              <div>
              ...
              <div className="flex items-center gap-4 pt-6">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => setSurveyData({
                      ...surveyData,
                      config: { ...surveyData.config, allowAnonymous: e.target.checked }
                    })}
                  />
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => setSurveyData({
                      ...surveyData,
                      config: { ...surveyData.config, requiresAuth: e.target.checked }
                    })}
                  />
